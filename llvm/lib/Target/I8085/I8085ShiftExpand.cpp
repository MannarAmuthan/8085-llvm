//===- I8085Shift.cpp - Shift Expansion Pass --------------------------------===//
//
...
class I8085ShiftExpand : public FunctionPass {
public:
  static char ID;

  I8085ShiftExpand() : FunctionPass(ID) {}

  bool runOnFunction(Function &F) override;

  StringRef getPassName() const override { return "I8085 Shift Expansion"; }
...
char I8085ShiftExpand::ID = 0;

INITIALIZE_PASS(I8085ShiftExpand, "avr-shift-expand", "I8085 Shift Expansion",
                false, false)

Pass *llvm::createI8085ShiftExpandPass() { return new I8085ShiftExpand(); }

bool I8085ShiftExpand::runOnFunction(Function &F) {
...
void I8085ShiftExpand::expand(BinaryOperator *BI) {
