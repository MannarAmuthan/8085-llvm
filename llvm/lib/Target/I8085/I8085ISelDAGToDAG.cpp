...
template <> bool I8085DAGToDAGISel::select<ISD::LOAD>(SDNode *N) {
  ...
  int ProgMemBank = I8085::getProgramMemoryBank(LD);
  ...
  Chain = CurDAG->getCopyToReg(Chain, DL, I8085::R31R30, Ptr, SDValue());
  Ptr = CurDAG->getCopyFromReg(Chain, DL, I8085::R31R30, MVT::i16,
                               Chain.getValue(1));
  ...
  if (unsigned LPMOpc = selectIndexedProgMemLoad(LD, VT, ProgMemBank)) {
    ...
    if (ProgMemBank == 0) {
      ...
      auto *NP = CurDAG->getMachineNode(I8085::LDIRdK, DL, MVT::i8, NC);
    ...
    case MVT::i8:
      if (ProgMemBank == 0) {
        ResNode =
            CurDAG->getMachineNode(I8085::LPMRdZ, DL, MVT::i8, MVT::Other, Ptr);
      } else {
        // Do not combine the LDI instruction into the ELPM pseudo instruction,
        // since it may be reused by other ELPM pseudo instructions.
        SDValue NC = CurDAG->getTargetConstant(ProgMemBank, DL, MVT::i8);
        auto *NP = CurDAG->getMachineNode(I8085::LDIRdK, DL, MVT::i8, NC);
        ResNode = CurDAG->getMachineNode(I8085::ELPMBRdZ, DL, MVT::i8, MVT::Other,
                                         Ptr, SDValue(NP, 0));
      }
      break;
    case MVT::i16:
      if (ProgMemBank == 0) {
        ResNode =
            CurDAG->getMachineNode(I8085::LPMWRdZ, DL, MVT::i16, MVT::Other, Ptr);
      } else {
        // Do not combine the LDI instruction into the ELPM pseudo instruction,
        // since LDI requires the destination register in range R16~R31.
        SDValue NC = CurDAG->getTargetConstant(ProgMemBank, DL, MVT::i8);
        auto *NP = CurDAG->getMachineNode(I8085::LDIRdK, DL, MVT::i8, NC);
        ResNode = CurDAG->getMachineNode(I8085::ELPMWRdZ, DL, MVT::i16,
...
template <> bool I8085DAGToDAGISel::select<I8085ISD::CALL>(SDNode *N) {
  SDValue InFlag;
  ...
  SDLoc DL(N);
  Chain = CurDAG->getCopyToReg(Chain, DL, I8085::R31R30, Callee, InFlag);
  SmallVector<SDValue, 8> Ops;
  Ops.push_back(CurDAG->getRegister(I8085::R31R30, MVT::i16));
  ...
  SDNode *ResNode =
      CurDAG->getMachineNode(I8085::ICALL, DL, MVT::Other, MVT::Glue, Ops);
...
template <> bool I8085DAGToDAGISel::select<ISD::BRIND>(SDNode *N) {
  ...
  Chain = CurDAG->getCopyToReg(Chain, DL, I8085::R31R30, JmpAddr);
  SDNode *ResNode = CurDAG->getMachineNode(I8085::IJMP, DL, MVT::Other, Chain);
...
bool I8085DAGToDAGISel::selectMultiplication(llvm::SDNode *N) {
  SDLoc DL(N);
  ...
  unsigned MachineOp = isSigned ? I8085::MULSRdRr : I8085::MULRdRr;
  ...
  if (N->hasAnyUseOfValue(0)) {
    SDValue CopyFromLo =
        CurDAG->getCopyFromReg(InChain, DL, I8085::R0, Type, InGlue);
  ...
  if (N->hasAnyUseOfValue(1)) {
    SDValue CopyFromHi =
        CurDAG->getCopyFromReg(InChain, DL, I8085::R1, Type, InGlue);
